...
# Setup localization
APP_ID = "com.github.catoblepa.p7mviewer"
            ...
            if os.path.exists(self.file_estratto):
                ...
                try:
                    ...
                    if content_type and content_type != "application/octet-stream":
                        ...
                        self.label_info_file.set_markup(f'<span size="small" color="#f57c00">⚠️ {_("File type not recognized, cannot open automatically")}</span>')
                except Exception as e:
